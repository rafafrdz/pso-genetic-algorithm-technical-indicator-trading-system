...
import mf.dabi.pso.techIndicatorTradingSystem.finance.indicators.Signal.{indd1, indd2}
...
object Experiment extends Sparkable {
  ...
  val INITIAL_CAPITAL: Long = 4000000
  val THRES_HOLD: Double = 0.8


  /** Importante no borrar */
  val indicators: List[SignalIndicator] = setAmount(INITIAL_CAPITAL, indd2)
...
//  lazy val exp1: ParticleSolution = PSOAlgorithm.algorithm(2, 5, space)(wi, c1, c2)("AAPL", "2017-01-03", space.indicators, TradingFunction.profit)
  lazy val exp2: ParticleSolution = PSOAlgorithm.algorithm(5, 5, space)(wi, c1, c2)("AAPL", "2021-06-01", space.indicators, TradingFunction.profit)


  def main(args: Array[String]): Unit = {
    val data: ParticleSolution = DataFrameSuite.benchmark(exp2)
    Write(data.trading).parquet("src/main/resources/historical-data/results/AAPL/exp1")
    0
  }
